...
```{r problem_sample_plots, echo = FALSE, out.width = '100%', fig.out = 10, dpi = 120}
 ...
 for (i in 2:ncol(full_data)){
  ...
  hm_plot <- heatmap_analysis(combined, colnames(combined)[2], colnames(combined)[3], neg_lag = -5, pos_lag = 5, win = 21, center = 0, complete = FALSE, sel_col_pal = 1, font_size = 8, axis_line_width = 0.5, plot_line = 0.75, leg_size = 1)
