...
line_plot<-function(the_data, series_1_nm, series_2_nm, lag = 0, text_size = 12, line_width = 1, plot_line = 0.5){
  ...
  if (class(lag) != "numeric" || lag %% 1 != 0){
    ...
    plot1<-ggplot()+
      ...
      R_dateR_theme(text_size = text_size, line_width = line_width) +
